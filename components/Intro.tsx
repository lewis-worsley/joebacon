      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center">
        <div className="order-1 md:order-2 flex justify-center md:justify-end mb-5 md:mb-0 md:bg-transparent rounded-full">
          <Image
            ...
            width={300}
            height={300}
            className="size-60 md:min-w-[300px] md:max-w-[300px] md:size-fit rounded-full md:rounded-none md:border-0 object-contain object-top p-1"
          />
        </div>
        <div className="order-2 md:order-1 flex flex-col space-y-5 text-center md:text-left place-items-center md:place-items-start md:mr-10">
          ...
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold">Marketing & Communication Services</h1>
